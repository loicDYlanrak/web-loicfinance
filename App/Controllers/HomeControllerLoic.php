...
use App\Models\CroissanceSectorielleLoic;
use App\Models\RecetteLoic;
use Flight;
...
class HomeController {
    ...
    public static function index() {
        ...
        $croissanceModel = new CroissanceSectorielleLoic(Flight::db());
        $recetteModel = new RecetteLoic(Flight::db());
